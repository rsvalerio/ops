...
#### 🐛 Bug Fixes
- (**about**) distinguish an unregistered units provider from an empty unit list - ([07d1675](https://github.com/rsvalerio/ops/commit/07d16755662a26224dd0dee6195388be1531a1e2)) - [@rsvalerio](https://github.com/rsvalerio)
- (**about-go**) stop counting local replace targets as modules - ([e35c605](https://github.com/rsvalerio/ops/commit/e35c605bc747a7d6431b921aaef7bceb7a40d28a)) - [@rsvalerio](https://github.com/rsvalerio)
- (**about-go**) report and roll back unterminated use/replace blocks at EOF - ([d55f1fc](https://github.com/rsvalerio/ops/commit/d55f1fc8ed842c1f6e991ce399bd5f93c5028882)) - [@rsvalerio](https://github.com/rsvalerio)
- (**about-java**) fill homepage from the POM url and list modules and subprojects as project units - ([04bdf84](https://github.com/rsvalerio/ops/commit/04bdf849889de4b137a1ead188a1dd7a8ee6a6e0)) - [@rsvalerio](https://github.com/rsvalerio)
- (**about-java**) depth-gate and deduplicate gradle include entries - ([88c5d58](https://github.com/rsvalerio/ops/commit/88c5d5880ba87cea97d5019c34f2ea80cc731531)) - [@rsvalerio](https://github.com/rsvalerio)
- (**about-java**) warn on unterminated pom.xml constructs at end of input - ([6f86180](https://github.com/rsvalerio/ops/commit/6f86180896d7d61c4133f209a62c1312202cb9bb)) - [@rsvalerio](https://github.com/rsvalerio)
- (**about-node**) report a malformed package.json once per run - ([155fd41](https://github.com/rsvalerio/ops/commit/155fd41a93bd0d0e63165af4fe6d6366cf5dc3da)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**about-node**) derive module_count from the resolved workspace members - ([f8acefb](https://github.com/rsvalerio/ops/commit/f8acefb038a46cce339212b122a6c6605bc5e67d)) - [@rsvalerio](https://github.com/rsvalerio)
- (**about-node**) honour only a top-level packages key in pnpm-workspace.yaml - ([d83fe88](https://github.com/rsvalerio/ops/commit/d83fe888648622ad0be49c5f22a5f27c63af8033)) - [@rsvalerio](https://github.com/rsvalerio)
- (**about-node**) apply control-char and scheme policies to homepage and drop userinfo authorities - ([f4952ef](https://github.com/rsvalerio/ops/commit/f4952efb896654c0bc498884550463d57a41c8ec)) - [@rsvalerio](https://github.com/rsvalerio)
- (**about-python**) derive module_count from the resolved uv workspace members - ([f11bd33](https://github.com/rsvalerio/ops/commit/f11bd339b986e6889bf2cebd9c59bc213c384311)) - [@rsvalerio](https://github.com/rsvalerio)
- (**about-python**) degrade non-string project.urls entries per-entry - ([0582276](https://github.com/rsvalerio/ops/commit/0582276dfc054f30923e117c4aebd2b5a31033aa)) - [@rsvalerio](https://github.com/rsvalerio)
- (**about-terraform**) refuse .tf files ending inside unterminated constructs - ([3693262](https://github.com/rsvalerio/ops/commit/3693262612fba3bafe892dc7c430ff64b606d0cd)) - [@rsvalerio](https://github.com/rsvalerio)
- (**about-terraform**) name the source .tf file in parser and sanitizer warnings - ([49b8951](https://github.com/rsvalerio/ops/commit/49b8951b209e0b3ea23b629a02b930df2557f6d0)) - [@rsvalerio](https://github.com/rsvalerio)
- (**backlog**) emit createdAt/updatedAt only from parseable frontmatter dates - ([977439a](https://github.com/rsvalerio/ops/commit/977439a4fdb062328f19b216190e83b87c03171a)) - [@rsvalerio](https://github.com/rsvalerio)
- (**backlog**) surface unreadable lookup directories from Store::find - ([8bb7b97](https://github.com/rsvalerio/ops/commit/8bb7b975450b5a2c4df2ebd7214397add4d760ad)) - [@rsvalerio](https://github.com/rsvalerio)
- (**backlog**) make task-file rewrites atomic and crash-safe - ([d29bdf3](https://github.com/rsvalerio/ops/commit/d29bdf3659137962872e193fec3553534e6e189a)) - [@rsvalerio](https://github.com/rsvalerio)
- (**cargo-toml**) resolve the provider's workspace root with the strict walk - ([54156fe](https://github.com/rsvalerio/ops/commit/54156fe291c26a95830db68b1ce1fd29dec31d7c)) - [@rsvalerio](https://github.com/rsvalerio)
- (**cli**) resolve init cwd through the contextual cwd() helper - ([ce3ef01](https://github.com/rsvalerio/ops/commit/ce3ef01865ab53225d189a0274d3da56b725ce0a)) - [@rsvalerio](https://github.com/rsvalerio)
- (**config-checkers**) spawn check-json/check-yaml via a shared current_exe resolver - ([b82d276](https://github.com/rsvalerio/ops/commit/b82d27630a35d97adefa0d09b2641c91aa7cad11)) - [@rsvalerio](https://github.com/rsvalerio)
- (**create-review-tasks**) emit the root package of a hybrid manifest as a review target - ([87fe0b4](https://github.com/rsvalerio/ops/commit/87fe0b4b3f3ae1f4a907240487cef4d975541db2)) - [@rsvalerio](https://github.com/rsvalerio)
- (**create-review-tasks**) surface rollback failures and keep committed sets successful on report write errors - ([cf340d5](https://github.com/rsvalerio/ops/commit/cf340d53369de936bd2f6335f9046ac6ea7799c8)) - [@rsvalerio](https://github.com/rsvalerio)
- (**deps**) hold the unknown-severity warning to one line per has_issues call - ([59bfa2b](https://github.com/rsvalerio/ops/commit/59bfa2bf5ae0a473768f454c8ddc41bc8f2afcdc)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**deps**) apply the partial-decode-loss guards to exit-0 deny runs and partial upgrade row loss - ([681fdba](https://github.com/rsvalerio/ops/commit/681fdba386174e9873566a025115d8f460755205)) - [@rsvalerio](https://github.com/rsvalerio)
- (**duckdb**) refuse a symlinked staging parent before hardening it - ([31b2aa1](https://github.com/rsvalerio/ops/commit/31b2aa142479a8f994d832fb83aef7f9f276f0e3)) - [@rsvalerio](https://github.com/rsvalerio)
- (**duckdb**) preserve typed provider timeouts through the ingest orchestrator - ([8d5af77](https://github.com/rsvalerio/ops/commit/8d5af774219b95b1d982fe5247f4e2812170ddff)) - [@rsvalerio](https://github.com/rsvalerio)
- (**extension**) clear provider dispatch state through a Drop guard on panic - ([6c6ea3e](https://github.com/rsvalerio/ops/commit/6c6ea3e1c2c23533874c8c942c8ee8621a45cea7)) - [@rsvalerio](https://github.com/rsvalerio)
- (**git**) preserve the explicit port in normalized remote URLs - ([d03f350](https://github.com/rsvalerio/ops/commit/d03f350ff10ccfde7f68222a39fccec8668c7c18)) - [@rsvalerio](https://github.com/rsvalerio)
- (**hook-common**) name the offending path in install error contexts - ([edd3eec](https://github.com/rsvalerio/ops/commit/edd3eec2342f5504de9044c14c1fc30fdd7cf2a7)) - [@rsvalerio](https://github.com/rsvalerio)
- (**hooks**) share the missing-ops prologue and make the pre-push capture fail closed and bounded - ([94be35f](https://github.com/rsvalerio/ops/commit/94be35f55fcaf40503c8c66cac6a981dc5a204fa)) - [@rsvalerio](https://github.com/rsvalerio)
- (**metadata**) refuse a cargo-metadata stdout truncated by the subprocess capture cap - ([57eba38](https://github.com/rsvalerio/ops/commit/57eba384b34499b1e1ccfbd61399d9b524f7e0c7)) - [@rsvalerio](https://github.com/rsvalerio)
- (**rust-loc**) enforce the memory cap against the opened handle - ([25d7333](https://github.com/rsvalerio/ops/commit/25d73332ac2cf12da32485590129a040245a6d24)) - [@rsvalerio](https://github.com/rsvalerio)
- (**text-fixers**) keep stale stage files out of fixer candidates - ([d6eac29](https://github.com/rsvalerio/ops/commit/d6eac29d61896384c1db28cde9f8253539c257a8)) - [@rsvalerio](https://github.com/rsvalerio)
- (**text-fixers**) document and pin tracked-mode exclusion semantics - ([9aa0b01](https://github.com/rsvalerio/ops/commit/9aa0b01742fcf03390b352c256695ae8a450c00d)) - [@rsvalerio](https://github.com/rsvalerio)
- (**text-fixers**) keep single-line CRLF files unchanged in fix_eof - ([c5ae572](https://github.com/rsvalerio/ops/commit/c5ae572c69b30b7d45893c5de6edd8ad1eed2ca5)) - [@rsvalerio](https://github.com/rsvalerio)
- (**tfplan**) harden plan-JSON ingress against symlinks, races, and hangs - ([544deb5](https://github.com/rsvalerio/ops/commit/544deb547a425e329e053ec3e0bf19d7a5e5a879)) - [@rsvalerio](https://github.com/rsvalerio)
- (**theme**) clamp the summary separator to the column budget - ([6819169](https://github.com/rsvalerio/ops/commit/68191696a56beae9c8bf5168ac31d0196240303e)) - [@rsvalerio](https://github.com/rsvalerio), Claude Code
- (**tokei**) sort flattened records by file and language for byte-stable output - ([db8d49d](https://github.com/rsvalerio/ops/commit/db8d49d076fd6dd88d31e21fbc71c6b814c64ac8)) - [@rsvalerio](https://github.com/rsvalerio)
- address code-review findings across extensions and crates - ([82dfa8a](https://github.com/rsvalerio/ops/commit/82dfa8a42d83c5ce2f31665929dc399b9ea0a23b)) - [@rsvalerio](https://github.com/rsvalerio), Claude Code
#### ⚡ Performance
- (**core**) bound the stack-detect canonicalize cache with FIFO eviction - ([1f2ae6a](https://github.com/rsvalerio/ops/commit/1f2ae6acea543d26f5b9493bc3d83d082b985f08)) - [@rsvalerio](https://github.com/rsvalerio)
- (**create-review-tasks**) buffer task-file writes and stop the claim re-check at the first conflict - ([6299367](https://github.com/rsvalerio/ops/commit/6299367a04ce3ce66d545629b74b15073a2d6bb0)) - [@rsvalerio](https://github.com/rsvalerio)
- (**duckdb**) drop the redundant BufReader in checksum_reader - ([c1f9286](https://github.com/rsvalerio/ops/commit/c1f9286e0bfaac75b5dca372dc29d9daa330acc7)) - [@rsvalerio](https://github.com/rsvalerio)
- (**duckdb**) make the query_project_row error context lazy - ([7a0bfc3](https://github.com/rsvalerio/ops/commit/7a0bfc3bf723fbf4f572e2125935ec95be7c6ea7)) - [@rsvalerio](https://github.com/rsvalerio)
- (**runner**) take plan and scheduling flags from one expand walk - ([85f67f5](https://github.com/rsvalerio/ops/commit/85f67f53dcd14020c62d73e6014107d86ed117c6)) - [@rsvalerio](https://github.com/rsvalerio)
- (**text-fixers**) scan before allocating in fix_trailing - ([6cb3a2d](https://github.com/rsvalerio/ops/commit/6cb3a2d09f36633c8836dcb5642c8a9e17752cd7)) - [@rsvalerio](https://github.com/rsvalerio)
- (**theme**) resolve the colour gate once per render entry point - ([c055cb4](https://github.com/rsvalerio/ops/commit/c055cb43481510b2b7fa4367280a57e9ddfd5063)) - [@rsvalerio](https://github.com/rsvalerio)
- (**tokei**) count candidates directly instead of re-walking via get_statistics - ([56c115e](https://github.com/rsvalerio/ops/commit/56c115e11b07bcfd20ebb23961c2975ecc35c1b7)) - [@rsvalerio](https://github.com/rsvalerio)
#### 📚 Documentation
- (**about**) document the about extension surface and explain every must_use - ([7a5a445](https://github.com/rsvalerio/ops/commit/7a5a445e5de1c72cba65104fbadbd9d2f130bf20)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**about-go**) state the go.mod grammar, traversal and go.work precedence rules - ([559304a](https://github.com/rsvalerio/ops/commit/559304a98575f4c1523b46940e7380b4b30fcfc6)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**about-java**) describe the Maven and Gradle parsing rules as they stand - ([d8fc5b4](https://github.com/rsvalerio/ops/commit/d8fc5b4c816c8af94a12d8d0c6e0f5837b2d25ca)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**about-node**) state the URL and package-manager rules as current behaviour - ([0c90c85](https://github.com/rsvalerio/ops/commit/0c90c85a6e657d5a5152240008401588202796d1)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**about-python**) state the URL and license normalisation policy once - ([f74b0c2](https://github.com/rsvalerio/ops/commit/f74b0c243ba274453d47f6fa014b6b272df25075)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**about-rust**) document the manifest-cache member-set freeze contract - ([e779406](https://github.com/rsvalerio/ops/commit/e779406ad3079ed8794f20485068efe078414845)) - [@rsvalerio](https://github.com/rsvalerio)
- (**cargo-toml**) document the nearest-ancestor workspace rule and pin it with a test - ([599ae9c](https://github.com/rsvalerio/ops/commit/599ae9c334ca623e2cb1d67d086e1339d598e85e)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**cargo-toml**) correct the lenient-walk mechanism in the strict-vs-lenient test - ([8c89ba1](https://github.com/rsvalerio/ops/commit/8c89ba1118a35a2fe8285fcddc8ff5945b5757f4)) - [@rsvalerio](https://github.com/rsvalerio)
- (**cli**) keep the about subcommand rationale out of user-facing help - ([513c594](https://github.com/rsvalerio/ops/commit/513c59450bd5f2b889a302877c31c8ee81bdc8cc)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**core**) add crate-level docs and summaries for the extension surface - ([8c17218](https://github.com/rsvalerio/ops/commit/8c17218e848481af750cc10e61a858f04b5f20a5)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**deps**) describe the current parsing and formatting contracts - ([01e6750](https://github.com/rsvalerio/ops/commit/01e6750dc4379ecab3a13eca8fb1abf6f1e4e9f4)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**extension**) drop the doc-anchor module and the design-journal essays - ([9b9a681](https://github.com/rsvalerio/ops/commit/9b9a68176b7567a262dbb12f1a32067854e5ed0d)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**extension**) point the data.rs split note at the right modules - ([fcbe380](https://github.com/rsvalerio/ops/commit/fcbe380cc264ef1493886f1cdce0a1279752393b)) - [@rsvalerio](https://github.com/rsvalerio), Claude Code
- (**extensions**) add doc summaries across the cargo, deps, loc, duckdb and tokei surfaces - ([70cc2d1](https://github.com/rsvalerio/ops/commit/70cc2d1d9c079b35698af70c1fad8dd0ea4f339e)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**extensions-rust**) describe the end state in cargo-update, loc, metadata and create-review-tasks - ([871148a](https://github.com/rsvalerio/ops/commit/871148ab6d65f0ea69c7e4a5b11d0e23748d396f)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**hooks**) describe the enduring hook properties without task history - ([c78a2d2](https://github.com/rsvalerio/ops/commit/c78a2d2b11c04e1600b98660700a654fd7a27b7c)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**loc**) stop public docs linking at pub(crate) counter items - ([d2ae475](https://github.com/rsvalerio/ops/commit/d2ae475152881886d448f15908a6b8e87b10fce5)) - [@rsvalerio](https://github.com/rsvalerio), Claude Code
- (**runner**) state the current contracts and emit log values as named fields - ([32ed369](https://github.com/rsvalerio/ops/commit/32ed369d686af6ee9cc9d3c8af9d77a54b9ebf41)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**terraform**) open every doc with what the item does - ([79877e7](https://github.com/rsvalerio/ops/commit/79877e7d0b399669df3d5c1e594c3a5f9ff5a25e)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**text-fixers**) state the guarantees the fixers make today - ([72b87ae](https://github.com/rsvalerio/ops/commit/72b87ae813adf760ad72213527d1146556eaff19)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
#### 🧪 Testing
- (**about-go**) exercise GoUnitsProvider and the extension's registrations - ([cce7641](https://github.com/rsvalerio/ops/commit/cce764141bf88e852bf0438ae71f38daaa93a9f4)) - [@rsvalerio](https://github.com/rsvalerio)
- (**about-java**) cover both extensions' factories, registrations and about-fields - ([e0d83bc](https://github.com/rsvalerio/ops/commit/e0d83bcc84b566725faed4bbd2b6bc246c4d49ff)) - [@rsvalerio](https://github.com/rsvalerio)
- (**about-node**) cover register_data_providers and the linkme factory - ([becc17d](https://github.com/rsvalerio/ops/commit/becc17d43222f154ed2f82bcfe4a3f6d7fad3f5a)) - [@rsvalerio](https://github.com/rsvalerio)
- (**about-python**) assert the malformed-root warn and add its recovery field - ([f615793](https://github.com/rsvalerio/ops/commit/f615793f7dadb7904c2b513af243cc3f87de441a)) - [@rsvalerio](https://github.com/rsvalerio)
- (**about-python**) exercise PythonUnitsProvider and the extension's registrations - ([a12117b](https://github.com/rsvalerio/ops/commit/a12117b9f99ed2c630b508bf259cb940157ca708)) - [@rsvalerio](https://github.com/rsvalerio)
- (**about-rust**) canonicalize workspace_fixture root for symlinked TMPDIRs - ([d84b70a](https://github.com/rsvalerio/ops/commit/d84b70a1e11cd0ea7b438d572fea6e763bfbbbcb)) - [@rsvalerio](https://github.com/rsvalerio), Claude Code
- (**about-rust**) cover per_crate_units and every RustCoverageProvider::provide arm - ([f01d088](https://github.com/rsvalerio/ops/commit/f01d088e7aaa5fcc7b623468402d7d185f29a507)) - [@rsvalerio](https://github.com/rsvalerio)
- (**core**) surface skipped test preconditions instead of passing vacuously - ([ac3c5f7](https://github.com/rsvalerio/ops/commit/ac3c5f7ed2779466eb9cc1f2512c9d427dc4159a)) - [@rsvalerio](https://github.com/rsvalerio)
- (**create-review-tasks-rust**) drive the registration test through the engine's lookup key - ([643b21d](https://github.com/rsvalerio/ops/commit/643b21de2f5f7e835865878df91e931c93f4f7c0)) - [@rsvalerio](https://github.com/rsvalerio)
- (**extension**) move the public-API suite to tests/ - ([b602f78](https://github.com/rsvalerio/ops/commit/b602f7865cb9ece2744bfaa537943838996bf636)) - [@rsvalerio](https://github.com/rsvalerio)
- (**git**) scope the control-byte test to the drop behaviour - ([8542ff6](https://github.com/rsvalerio/ops/commit/8542ff6b53badc1b8bb04bc65334782b4870c1bb)) - [@rsvalerio](https://github.com/rsvalerio)
- (**metadata**) skip the re-exec output-cap child when run without its parent - ([4ba5d77](https://github.com/rsvalerio/ops/commit/4ba5d77875f655eeab4a5034662e37b32e01bd65)) - [@rsvalerio](https://github.com/rsvalerio), Claude Code
- (**metadata**) pin the cap-guard NULL shape instead of the 100-MiB error text - ([c8d972b](https://github.com/rsvalerio/ops/commit/c8d972bb866a4743f0a4f6a7afd09c8e66de8d04)) - [@rsvalerio](https://github.com/rsvalerio)
- (**python-about**) use ops_about::test_support::write_file instead of a local copy - ([ddb3511](https://github.com/rsvalerio/ops/commit/ddb351192ef367f64bbc28e24c8609d5695063fb)) - [@rsvalerio](https://github.com/rsvalerio), Claude Code
- (**run-before-commit**) harden missing-ops PATH, serialise spawners, pin HOOK_CONFIG - ([ee1b91d](https://github.com/rsvalerio/ops/commit/ee1b91daf348d8543b6431a5785cbf674ede366f)) - [@rsvalerio](https://github.com/rsvalerio)
- (**run-before-push**) make the missing-ops probe unconditional and serialise spawners - ([ad6b345](https://github.com/rsvalerio/ops/commit/ad6b34572c93f2cd7110e648ee0e3d3ce04a740c)) - [@rsvalerio](https://github.com/rsvalerio)
- (**runner**) serialise the OUTPUT_BYTE_CAP memoization test - ([9919a2c](https://github.com/rsvalerio/ops/commit/9919a2c21cbbf30af0b07d88ceb15e286be9f749)) - [@rsvalerio](https://github.com/rsvalerio)
- (**test-coverage**) stage the zero-counts fixture through IngestDir::write_atomic - ([a7b7928](https://github.com/rsvalerio/ops/commit/a7b7928f84ecf501ddeac8689e817d56e7152ec7)) - [@rsvalerio](https://github.com/rsvalerio)
- (**test-coverage**) bind the schema to CoverageRow and cover provide/provide_from_db - ([33c7714](https://github.com/rsvalerio/ops/commit/33c7714ea338375b0669d51dcdfa1759f7313d68)) - [@rsvalerio](https://github.com/rsvalerio)
#### 🔧 Build System
- (**lints**) forbid unsafe code in ops-theme, ops-backlog, and ops-extension - ([f963394](https://github.com/rsvalerio/ops/commit/f96339476e257e667660a5b1859a3a4985d32f6d)) - [@rsvalerio](https://github.com/rsvalerio)
#### 🔄 CI/CD
- (**miri**) run Miri over the core and runner unsafe in CI - ([b129c10](https://github.com/rsvalerio/ops/commit/b129c10096c7cf86fb3b6217f04537a26380a687)) - [@rsvalerio](https://github.com/rsvalerio)
#### 🚜 Refactoring
- (**about**) emit warn values as structured fields instead of interpolating them - ([7e329c7](https://github.com/rsvalerio/ops/commit/7e329c7027e6ea2cfebe8375d415d92342b71605)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**about**) explain the BoundedLruCache must_use attributes - ([0519d41](https://github.com/rsvalerio/ops/commit/0519d413bbcaf153a15c92f0e893ca43d36ecfc0)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**about**) drop root re-exports that duplicate the subpage module paths - ([60d735d](https://github.com/rsvalerio/ops/commit/60d735d762ff7906dd3ee1905a6f0d3cc8ab9119)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**about**) own the LRU cache scaffold in ops_about::lru::BoundedLruCache - ([0dfab8a](https://github.com/rsvalerio/ops/commit/0dfab8a1cb0a7c4a8feed9e90330beabd29bc0b8)) - [@rsvalerio](https://github.com/rsvalerio), Claude Code
- (**about**) route contains_control_chars through the shared display-safety predicate - ([cdb6a7c](https://github.com/rsvalerio/ops/commit/cdb6a7c3e9d17c0ebd04ac51a38f32cdc3345272)) - [@rsvalerio](https://github.com/rsvalerio)
- (**about-rust**) unify the SEC-14 member-safety reject-and-warn breadcrumb - ([86e9139](https://github.com/rsvalerio/ops/commit/86e91394af99c5657825c326dd9eb2347edaa0f3)) - [@rsvalerio](https://github.com/rsvalerio)
- (**backlog**) move the unchecked-items constructor into model.rs as AcItem::unchecked_all - ([5936104](https://github.com/rsvalerio/ops/commit/5936104d7bbc10070e7f81087aa6e788d2420581)) - [@rsvalerio](https://github.com/rsvalerio), Claude Code
- (**backlog**) split run_edit into frontmatter-edit, body-edit helpers - ([cd5fb8b](https://github.com/rsvalerio/ops/commit/cd5fb8b60d9ae7f2d37bcc65c2b9caf7ec443985)) - [@rsvalerio](https://github.com/rsvalerio), Claude Code
- (**backlog**) group push_scalar_fields extras-derived scalars into a named struct - ([39c94b2](https://github.com/rsvalerio/ops/commit/39c94b29fd95fc3a1fd55c3a099aa10e79dd7510)) - [@rsvalerio](https://github.com/rsvalerio), Claude Code
- (**backlog**) make the view/list output mode a single OutputFormat field - ([83773a1](https://github.com/rsvalerio/ops/commit/83773a1c22860c16763886679812a6abc5142837)) - [@rsvalerio](https://github.com/rsvalerio)
- (**cargo-update**) carry each action's versions in its own UpdateEntry variant - ([949f63f](https://github.com/rsvalerio/ops/commit/949f63f80bf9ebd01913c45ba15cb30121a8d614)) - [@rsvalerio](https://github.com/rsvalerio)
- (**config-checkers**) enforce the check report with must_use and document the surface - ([cdca75b](https://github.com/rsvalerio/ops/commit/cdca75bf7fca1407dbcfb0412450824bd973968c)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**config-checkers**) single-source MAX_NESTING_DEPTH from the json checker - ([1523bd7](https://github.com/rsvalerio/ops/commit/1523bd765c1964aee3add4027b5f6eeec42f4099)) - [@rsvalerio](https://github.com/rsvalerio)
- (**config-checkers**) read candidates through the shared bounded-read pipeline - ([efaa153](https://github.com/rsvalerio/ops/commit/efaa153f5673a2a10099e34a7c6bf9d46f187d26)) - [@rsvalerio](https://github.com/rsvalerio)
- (**core**) add the shared bounded-read pipeline for file-walking extensions - ([1772f69](https://github.com/rsvalerio/ops/commit/1772f696e1670243e5a88fc8a04db32d345804fc)) - [@rsvalerio](https://github.com/rsvalerio)
- (**create-review-tasks**) trim the re-exported surface and reject unknown provider fields - ([ea75ad8](https://github.com/rsvalerio/ops/commit/ea75ad8fc860117365551d08f37f003f0ac98e60)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**create-review-tasks**) render task files through the ops-backlog TaskDoc renderer - ([35aa9a3](https://github.com/rsvalerio/ops/commit/35aa9a32be09f7bb8306d0a2e763ec681eec7da3)) - [@rsvalerio](https://github.com/rsvalerio), Claude Code
- (**deps**) route every deny section through one severity_section_row scaffold - ([bbd9e0a](https://github.com/rsvalerio/ops/commit/bbd9e0a5efbbaf2fd94d2a6a83de8ead20141667)) - [@rsvalerio](https://github.com/rsvalerio), Claude Code
- (**duckdb**) share the sidecar relativize_path policy via ops_duckdb::sql - ([c311baa](https://github.com/rsvalerio/ops/commit/c311baafe85521c79da69cec36fd15021bc4e169)) - [@rsvalerio](https://github.com/rsvalerio), Claude Code
- (**extension**) split data.rs into data, context, deadline, db_handle - ([7a504d7](https://github.com/rsvalerio/ops/commit/7a504d770bd67b9e12eafa50535a13af1209e158)) - [@rsvalerio](https://github.com/rsvalerio), Claude Code
- (**git**) give each public item one canonical path and document the surface - ([c2549d2](https://github.com/rsvalerio/ops/commit/c2549d2be282e579be40d2d958d58fdec2331d14)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**git**) drop dead crate-root cast allows, reason the unwrap allow - ([041aa17](https://github.com/rsvalerio/ops/commit/041aa17a9e6216c2b1617f6fceb332d622140454)) - [@rsvalerio](https://github.com/rsvalerio), Claude Code
- (**git**) consume the shared display-safety predicate and name the full rejection policy in the dropped-url warn - ([defb383](https://github.com/rsvalerio/ops/commit/defb3831308322f7013ca58239f717b41df93e1d)) - [@rsvalerio](https://github.com/rsvalerio)
- (**go**) unify set_module and set_go_version on one first-wins directive setter - ([33b087e](https://github.com/rsvalerio/ops/commit/33b087e3149908a127677dc7c67d397c54faa634)) - [@rsvalerio](https://github.com/rsvalerio), Claude Code
- (**hook-common**) collapse duplicate hook-config paths and document the wrappers - ([1e14376](https://github.com/rsvalerio/ops/commit/1e14376741e99f225755a5b865a6e14f72c63f97)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**loc**) narrow count_source, count_fallback, MAX_NESTING_DEPTH to pub(crate) - ([1902d5e](https://github.com/rsvalerio/ops/commit/1902d5eccd5930c63c53f78df715c455d915a588)) - [@rsvalerio](https://github.com/rsvalerio), Claude Code
- (**metadata**) narrow the METADATA_MAX_BYTES consts to pub(crate) - ([baceb1e](https://github.com/rsvalerio/ops/commit/baceb1e41c2ce6b47aa4456435d638775f77a304)) - [@rsvalerio](https://github.com/rsvalerio), Claude Code
- (**plan**) thread the pipeline env as a value so tests stop mutating the process env - ([501fdf7](https://github.com/rsvalerio/ops/commit/501fdf7d8a3a3bdb5a716ba510c92d39ffbd532f)) - [@rsvalerio](https://github.com/rsvalerio)
- (**runner**) re-export looks_like_secret_value under its own name - ([cb86d04](https://github.com/rsvalerio/ops/commit/cb86d0480dd4ea7e30ec9cdb7161be186f2a0507)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**runner**) remove the dead canonical_id store-walk copy - ([50e9adb](https://github.com/rsvalerio/ops/commit/50e9adb21f65783ae132e2177a325a60f344e657)) - [@rsvalerio](https://github.com/rsvalerio), Claude Code
- (**runner**) thread exec handles through ExecEnv; drop dead canonical_id - ([b20565f](https://github.com/rsvalerio/ops/commit/b20565ff8197ca1c91311988c2ee00189fe62e5d)) - [@rsvalerio](https://github.com/rsvalerio), Claude Code
- (**terraform**) share the heredoc body tracker between strip_comments and scan_line - ([c89723f](https://github.com/rsvalerio/ops/commit/c89723fd9c96695ba67d3ea37ac9ce38f2e1708d)) - [@rsvalerio](https://github.com/rsvalerio), Claude Code
- (**text-fixers**) enforce FixerReport with must_use instead of the entry points - ([5593970](https://github.com/rsvalerio/ops/commit/5593970c68ee67bf27f1ef4a1bc654b0a0752d36)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**text-fixers**) read candidates through the shared bounded-read pipeline - ([81df84c](https://github.com/rsvalerio/ops/commit/81df84cc29d5259ab5aeaa6f8a45a6979cfc2002)) - [@rsvalerio](https://github.com/rsvalerio)
- (**tfplan**) drop duplicate re-exports and document the plan model - ([4942098](https://github.com/rsvalerio/ops/commit/494209807bb9804aa0076d8803b69430ac27c05c)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**theme**) make ops-theme the workspace's single ANSI grammar and expose strip_ansi_preserving_raw - ([63fedaa](https://github.com/rsvalerio/ops/commit/63fedaa24b09e90c2b7dcba22329dd29eea45b70)) - [@rsvalerio](https://github.com/rsvalerio), Claude Code
- (**theme**) return the template-overhead diagnostic instead of warning in new - ([4207fcb](https://github.com/rsvalerio/ops/commit/4207fcb3323e2e261dab425f5b57358032b71705)) - [@rsvalerio](https://github.com/rsvalerio)
- (**tokei**) split scan_tokei into validate, collect, and screen helpers - ([3ba9ee0](https://github.com/rsvalerio/ops/commit/3ba9ee06b3a775f3a7027ddb9775d45a252c1554)) - [@rsvalerio](https://github.com/rsvalerio), Claude Code
#### ⚙️ Miscellaneous
- (**backlog**) close code-review wave 14 (TASK-2248) - ([b8c68c0](https://github.com/rsvalerio/ops/commit/b8c68c096657d9e4dd5bda0b66553c1af959a5fb)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**backlog**) close code-review wave 13 (TASK-2247) - ([f11ced9](https://github.com/rsvalerio/ops/commit/f11ced9bb3673fc9a5abb4c2f961d36c6131ce58)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**backlog**) file wave 8 follow-ups (TASK-2258, TASK-2259, TASK-2260) - ([21f95ec](https://github.com/rsvalerio/ops/commit/21f95ecbed20e88555dfa502953d598cc5ed76fb)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**backlog**) close code-review wave 8 (TASK-2242) - ([29c67b0](https://github.com/rsvalerio/ops/commit/29c67b036d974645d5168500146d2d767a82117b)) - [@rsvalerio](https://github.com/rsvalerio), Claude Opus 5 (1M context)
- (**backlog**) close code-review wave 7 (TASK-2241) - ([77f107b](https://github.com/rsvalerio/ops/commit/77f107b8265e0d6f1caa45a025160140bb599ed6)) - [@rsvalerio](https://github.com/rsvalerio)
- (**backlog**) close code-review wave 12 - ([ee8deed](https://github.com/rsvalerio/ops/commit/ee8deed6c4a7c979828591fcf9099fb7966d4344)) - [@rsvalerio](https://github.com/rsvalerio), Claude Code
- (**backlog**) close code-review wave 10 (TASK-2244) - ([957f091](https://github.com/rsvalerio/ops/commit/957f0915b7ddc9a8aae81199a744eee2e794897b)) - [@rsvalerio](https://github.com/rsvalerio)
- (**backlog**) close code-review wave 9 - ([1a75a95](https://github.com/rsvalerio/ops/commit/1a75a95876279e59c427867cb501f27e0431dc8d)) - [@rsvalerio](https://github.com/rsvalerio)
- (**backlog**) close code-review wave TASK-2240 (provider-wiring-coverage) - ([f8633fe](https://github.com/rsvalerio/ops/commit/f8633fe3fd769a80cf6f09f3a22942882488fb68)) - [@rsvalerio](https://github.com/rsvalerio)
- (**backlog**) close code-review wave TASK-2235 (path-and-resource-safety) - ([59d39c8](https://github.com/rsvalerio/ops/commit/59d39c8161b4ab3d1bad9cfb2110128cea8f08cb)) - [@rsvalerio](https://github.com/rsvalerio)
- (**backlog**) apply task-file schema migration (assignee -> parent_task_id) - ([a8a7ebf](https://github.com/rsvalerio/ops/commit/a8a7ebfdb8d5928819b5d5294b6a92acc6e98bbe)) - [@rsvalerio](https://github.com/rsvalerio), Claude Code
- (**backlog**) close code-review wave 5 - ([f508682](https://github.com/rsvalerio/ops/commit/f5086823235918144c690aac0c6e7859d5c0ee58)) - [@rsvalerio](https://github.com/rsvalerio)
- (**backlog**) close code-review wave 4 - ([0435d7f](https://github.com/rsvalerio/ops/commit/0435d7f3b17abcd02741e7484b938a49a643654d)) - [@rsvalerio](https://github.com/rsvalerio)
- (**backlog**) close code-review wave 3 - ([cfd57e6](https://github.com/rsvalerio/ops/commit/cfd57e6d0b8fddc233c9cd4096165a89d4e500d2)) - [@rsvalerio](https://github.com/rsvalerio)
- (**backlog**) close code-review wave 11 - ([e19161d](https://github.com/rsvalerio/ops/commit/e19161db8a9c3682bf4955bdf23526de47b2eb18)) - [@rsvalerio](https://github.com/rsvalerio)
- (**backlog**) close code-review wave 2 - ([773e2d0](https://github.com/rsvalerio/ops/commit/773e2d0d7dfc954488e3c1ec8358a53b26ca2653)) - [@rsvalerio](https://github.com/rsvalerio)
- (**backlog**) close code-review wave 15 - ([87e82ea](https://github.com/rsvalerio/ops/commit/87e82ea65bc98ab2255146badbaa0d2038ee4d1e)) - [@rsvalerio](https://github.com/rsvalerio)
- (**backlog**) strip trailing whitespace baked into task-2076 - ([969b689](https://github.com/rsvalerio/ops/commit/969b6899ba15a22128511f9ed03f647d778f8c09)) - [@rsvalerio](https://github.com/rsvalerio), Claude Code
- ignore ops text-fixer staging files left by interrupted runs - ([e814140](https://github.com/rsvalerio/ops/commit/e814140b7e14d0e6817c82faecaf7573a53a4974)) - [@rsvalerio](https://github.com/rsvalerio)
- save backlog tasks - ([a732554](https://github.com/rsvalerio/ops/commit/a73255404d8686f4aae3fef9547aee0e444b63b2)) - [@rsvalerio](https://github.com/rsvalerio)
#### 🎨 Styling
- (**about-terraform**) wrap overlong return in extract_required_version - ([5def80e](https://github.com/rsvalerio/ops/commit/5def80e179200c4f6193bbadac23af85e475b39a)) - [@rsvalerio](https://github.com/rsvalerio)
