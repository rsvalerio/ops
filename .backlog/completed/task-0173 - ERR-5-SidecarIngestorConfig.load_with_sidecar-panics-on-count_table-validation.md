...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 load_with_sidecar returns a DbError instead of panicking on invalid count_table
- [x] #2 test asserts the error path with a deliberately invalid identifier
<!-- AC:END -->
