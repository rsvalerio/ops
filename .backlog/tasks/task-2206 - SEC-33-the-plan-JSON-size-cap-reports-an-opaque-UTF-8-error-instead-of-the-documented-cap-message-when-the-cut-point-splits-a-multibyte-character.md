---
id: TASK-2206
title: 'SEC-33: the plan-JSON size cap reports an opaque UTF-8 error instead of the documented cap message when the cut point splits a multibyte character'
status: Done
assignee: []
