...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 validate_cargo_tool_arg (or a rustup-specific equivalent) is applied to both component and toolchain in install_rustup_component_with_timeout
- [ ] #2 Unit-test rejecting "-foo" for both parameters
<!-- AC:END -->
