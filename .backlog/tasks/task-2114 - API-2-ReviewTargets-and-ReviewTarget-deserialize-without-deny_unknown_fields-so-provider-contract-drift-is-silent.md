...
id: TASK-2114
title: >-
  API-2: ReviewTargets and ReviewTarget deserialize without deny_unknown_fields,
  so provider contract drift is silent
status: To Do
assignee:
  - TASK-2247
...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 ReviewTargets and ReviewTarget reject unknown fields at decode time
- [ ] #2 A test asserts that a payload carrying an unexpected key fails with an error naming that key
- [ ] #3 The existing provider in extensions-rust/create-review-tasks still decodes cleanly under the stricter contract
<!-- AC:END -->
