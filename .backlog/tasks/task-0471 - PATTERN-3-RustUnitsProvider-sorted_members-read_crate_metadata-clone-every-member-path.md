...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Refactor RustUnitsProvider::provide to consume members directly (no double clone) and avoid the .clone() in the per-unit map closure where unnecessary
- [x] #2 Document the trade-off (or measure) so the change is not regressed
<!-- AC:END -->
