...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Negative i64 COUNT returns a DbError instead of silently defaulting to 0
- [x] #2 Test covers the negative-count error path using a mock
<!-- AC:END -->
