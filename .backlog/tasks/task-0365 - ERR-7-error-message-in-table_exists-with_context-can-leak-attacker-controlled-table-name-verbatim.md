...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Either validate table_name at the top of table_exists or sanitize/quote it in the error context
- [ ] #2 Test passes a control-character-laden table name and asserts the error message is sanitized
<!-- AC:END -->
