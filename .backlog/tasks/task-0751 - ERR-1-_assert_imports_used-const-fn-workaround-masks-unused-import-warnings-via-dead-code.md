...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Remove unused use lines from extension.rs (or replace with pub use re-exports), and drop the _assert_imports_used shim
- [x] #2 cargo check --all-features and cargo build --release produce no new warnings
<!-- AC:END -->
