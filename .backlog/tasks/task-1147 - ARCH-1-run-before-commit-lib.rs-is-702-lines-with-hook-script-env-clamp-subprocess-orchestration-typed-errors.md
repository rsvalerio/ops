...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Move has_staged_files_with_timeout, read_stderr_bounded, HasStagedFilesError, and git_timeout_from_env into ops_hook_common::git_state
- [x] #2 Keep a thin pub re-export in run-before-commit::lib so existing call sites compile unchanged
<!-- AC:END -->
